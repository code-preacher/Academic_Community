                ...
                <div class="row">
                   ...
                   <form action="#" method="post">
                      ...
                      if ($qt) {
                       ...
                       foreach($qt as $dy){
                         ?>
                         <option value="<?php echo $dy['id']; ?>"><?php echo ucfirst($dy['name']); ?></option>

                         <?php
                       }
                       
                     } else {
                      echo "<option><center>No Department at the moment</center</option>";
                    }
                    ?>
                          </select>
                          </div>
                                   ...
                                   <div class="col-md-4">
                           <button type="submit" name="submit" class="btn btn-primary btn-block btn-flat"><i class="fa fa-plus"></i>&nbsp;Add Lecturer</button>
                           </div>
