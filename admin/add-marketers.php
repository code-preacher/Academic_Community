      ...
      <div class="content-wrapper">
       ...
       <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Add Marketers</li>
          </ol>
        </section>
        <!-- Main content -->
                   ...
                   <form action="#" method="post">
                          ...
                          <select class="form-control" name="gender" required="required">
                             <option value="MALE">MALE</option>
                                    ...
                                    <div class="col-md-12">
                                  <div class="form-group has-feedback">
                          <input type="text" class="form-control" placeholder="Product Infomation" name="product" required="required" />
                          </div>
                                  </div>
                                   ...
                                   <div class="col-md-4">
                           <button type="submit" name="submit" class="btn btn-primary btn-block btn-flat"><i class="fa fa-plus"></i>&nbsp;Add Marketers</button>
                           </div>
