...
<html lang="zxx">
   <head>
      ...
      <meta name="keywords" content="COMMUNITY SOCIAL HANDLE" />
      <script>
   ...
   <body>
            ...
            <div class="container-fluid">
               <div class="hedder-up row">
                  <div class="col-lg-3 col-md-3 logo-head">
                     <h1><a class="navbar-brand" href="index.html">COMMUNITY SOCIAL HANDLE SYSTEM</a></h1>
                  </div>
               </div>
            </div>
                     ...
                     <div class="slider-img one-img">
                        <div class="container">
                           <div class="slider-info ">
                              <h5>Welcome <br>to COMMUNITY SOCIAL HANDLE System</h5>
      ...
      <footer class="py-lg-4 py-md-3 py-sm-3 py-3 text-center">
         <div class="copy-agile-right">
            <p> 
               COMMUNITY SOCIAL HANDLE SYSTEM
            </p>
         </div>
      </footer>
      <!-- //footer -->
