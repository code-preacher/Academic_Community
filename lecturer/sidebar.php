        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p><?php $n=$crud->displayLoginUser($_SESSION['id']); echo $n['name']?>   (Lecturer)</p>
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="chat.php">
            <i class="fa fa-comments"></i> <span>Lecturers Talk Zone</span></a> </li>
<li>
          <a href="chat2.php">
            <i class="fa fa-comments"></i> <span>Student Talk Zone</span></a> </li>
            <li>
          <a href="chat3.php">
            <i class="fa fa-comments"></i> <span>Marketers Talk Zone</span></a> </li>
