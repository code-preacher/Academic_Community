      ...
      <div class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header">
            <h1>Lecturer Talk Zone
              <small></small>
            </h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
              <li class="active">Lecturer Talk Zone</li>
            </ol>
          </section>
          ...
          <section class="content">
            ...
            <?php
            $user=$crud->displayUser3('lecturer',$_GET['id']); 
                ...
                <div id="myDirectChat" class="box box-warning direct-chat direct-chat-warning">
                  <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                     <a href="chat.php"> <span data-toggle="tooltip" class='fa fa-home'></span></a>
              ...
              <form action="reply.php" method="post">
                <div class="input-group">
                  <input type="text" name="message" placeholder="Type Message ..." class="form-control">
                    ...
                    <input type="hidden" name="lecturer_id" value="<?php echo $_SESSION['id'] ?>">
