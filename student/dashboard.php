              ...
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">
                     <?php 
                   echo $crud->countAllById3('student','department_id',$crud->displayDeptIdByEMail('student',$_SESSION['id']));
                  ?>
             ...
             <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">
                     <?php 
                  echo $crud->countAllById3('lecturer','department_id',$crud->displayDeptIdByEMail('student',$_SESSION['id']));
                  ?>
