      ...
      $crud->updateStatus($_GET['id'],$_SESSION['id']);
      ...
      <head>
        <meta charset="UTF-8">
        <title>COMMUNITY SOCIAL HANDLE | Dashboard</title>
      ...
      <div class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header">
            <h1>Marketers Talk Zone
              <small></small>
            </h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
              <li class="active">Marketers Talk Zone</li>
            </ol>
          </section>
          ...
          <section class="content">
            ...
            <?php
            $user=$crud->displayUser3('marketers',$_GET['id']); 
            $qt=$crud->displayAllWithOr2($user['email'],$_SESSION['id']);
            $qc=$crud->countAllById66($user['email'],$_SESSION['id']);
                ...
                <div id="myDirectChat" class="box box-warning direct-chat direct-chat-warning">
                  <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                     <a href="chat3.php"> <span data-toggle="tooltip" class='fa fa-home'></span></a>
                    ...
                    <div class="direct-chat-messages">
                      ...
                      if ($qt) {
                       ...
                       foreach($qt as $dy){
                        ...
                        if ($dy['sender']==$id) {
                          ...
                          <div class="direct-chat-msg">
                            <div class='direct-chat-info clearfix'>
                              ...
                              <span class='direct-chat-timestamp pull-right'><?php echo $dy['date_created']; ?></span>
                        ...
                        $user=$crud->displayUser3('student',$_GET['id']);
                        ?>

                        <!-- Message to the right -->
                        <div class="direct-chat-msg right">
                          <div class='direct-chat-info clearfix'>
                            <span class='direct-chat-name pull-right'><?php echo $user['name']; ?></span>
                            <span class='direct-chat-timestamp pull-left'><?php echo $dy['date_created']; ?></span>
                          </div><!-- /.direct-chat-info -->
                          <?php
                          if ($user['gender']=='male') {
                           ?>
            ...
            <div class="box-footer">
              <form action="reply3.php" method="post">
